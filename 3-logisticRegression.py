...
train_data = pd.read_csv('train_adj_normalize_2049.csv',index_col=0)
train_feature=train_data.drop(['1day_label','5day_label','10day_label'],axis=1)
train_target=train_data['10day_label']

test_data = pd.read_csv('test_adj_normalize_2049.csv',index_col=0)
test_feature=test_data.drop(['1day_label','5day_label','10day_label'],axis=1)
test_target=test_data['10day_label']


model=LogisticRegression(solver='lbfgs',penalty='l2',class_weight='balanced',C=400,max_iter=10000)
